...
model.fit({'input': X[0:trainsize]}, {'targets': Y[0:trainsize]}, n_epoch=20, validation_set=({'input': X[trainsize:totallen]}, {'targets': Y[trainsize:totallen]}),
